...
public:
   ...
   *   @exception SocketException thrown if fetch fails
   */
  unsigned short getLocalPort() throw();
   ...
   */
  void setLocalPort(unsigned short localPort) throw();
  ...
  void setLocalAddressAndPort(const string &localAddress, 
    unsigned short localPort = 0) throw();
...
public:
   ...
   */
  void send(const void *buffer, int bufferLen) throw();
   ...
   */
  int recv(void *buffer, int bufferLen) throw();
   ...
   */
  string getForeignAddress() throw();
   ...
   */
  unsigned short getForeignPort() throw();
...
public:
   ...
   */
  TCPSocket *accept() throw();

private:
  void setListen(int queueLen) throw();
};
...
public:
   ...
   */
  void setMulticastTTL(unsigned char multicastTTL) throw();
   ...
   */
  void joinGroup(const string &multicastGroup) throw();
   ...
   */
  void leaveGroup(const string &multicastGroup) throw();
